        ...
        <div class="col-xs-12 col-sm-12 col-md-5">
         ...
         <div class="col-xs-12 col-sm-12 col-md-5">
            <div class="form-group divimg">
              ...
              <input type="file" id="file" name="profile_picture" class="form-control" accept="image/png,image/jpg,image/jpeg" >
              <div id="preview"> </div>
            ...
            rules: {
              ...
              messages: {
                ...
                'password': {
                  ...
                  minlength:'<span style="color:red">Please enter min 8 character</span>'
                },
                'confirm_password': {
                  required: '<span style="color:red">Please enter the password</span>',
                  minlength:'<span style="color:red">Please enter min 8 character</span>',
